...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/seckill?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.kevin.seckill")
                .setEntity("pojo")
                .setMapper("mapper")
                .setService("service")
